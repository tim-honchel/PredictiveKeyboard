...
document.getElementById("buttonCenter").onclick = function () {
  pressButtonCenter();
};
...
function completeSearch() {
  ...
  document.getElementById("finished").innerHTML =
    "Search complete! Press backspace to start a new search.";
}
...
function loadDictionary() {
  ...
  fs.readFile("resources/dictionary.txt", (err, data) => {
    document.getElementById("testing").innerHTML =
      "function called, fs required, file read";
    if (err) throw err;
    document.getElementById("testing").innerHTML =
      "function called, fs required, file read, error checked";
    console.log(data.toString());
    document.getElementById("testing").innerHTML =
      "function called, fs required, file read, error checked, data logged";
  });
}
...
function pressButtonUp() {
  ...
  setTimeout(() => {
    document.getElementById("buttonUp").style.backgroundColor = "whitesmoke";
  }, 250);
...
function pressButtonDown() {
  ...
  setTimeout(() => {
    document.getElementById("buttonDown").style.backgroundColor = "whitesmoke";
  }, 250);
...
function pressButtonLeft() {
  ...
  setTimeout(() => {
    document.getElementById("buttonLeft").style.backgroundColor = "whitesmoke";
  }, 250);
  switch (selectorPosition) {
    case "cursor":
      deleteCharacter();
...
function pressButtonRight() {
  ...
  setTimeout(() => {
    document.getElementById("buttonRight").style.backgroundColor = "whitesmoke";
  }, 250);
  switch (selectorPosition) {
    case "cursor":
...
function pressButtonCenter() {
  ...
  setTimeout(() => {
    document.getElementById("buttonCenter").style.backgroundColor =
      "whitesmoke";
  }, 250);
  switch (selectorPosition) {
    case "cursor":
